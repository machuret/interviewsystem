  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-10">
      <div className="text-center mb-8">
        ...
        <p className="text-[#a1a1aa] text-sm">Just a few more details and your application is complete.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* Compensation */}
        <div>
          <p className="text-[#f97316] text-xs font-semibold uppercase tracking-widest mb-4">Compensation</p>

          <div className="space-y-4">
            <div>
              <label className="block text-[#a1a1aa] text-sm mb-1">Monthly Salary Expectation (PHP)<span className="text-[#f97316] ml-0.5">*</span></label>
            ...
            <div>
              <label className="block text-[#a1a1aa] text-sm mb-1">Payment Method<span className="text-[#f97316] ml-0.5">*</span></label>
              <div className="flex gap-4 mt-1">
                {["paypal", "wise"].map((method) => (
                  <label key={method} className="flex items-center gap-2 cursor-pointer select-none">
                    <input type="checkbox" className="w-4 h-4 accent-[#f97316]" checked={form.payment_methods.includes(method)} onChange={() => togglePayment(method)} />
            ...
            {form.payment_methods.includes("paypal") && (
              <div>
                <label className="block text-[#a1a1aa] text-sm mb-1">PayPal Email<span className="text-[#f97316] ml-0.5">*</span></label>
            ...
            {form.payment_methods.includes("wise") && (
              <div>
                <label className="block text-[#a1a1aa] text-sm mb-1">Wise Email<span className="text-[#f97316] ml-0.5">*</span></label>
        ...
        <div className="border-t border-[#2a2a2a] pt-5">
          <p className="text-[#f97316] text-xs font-semibold uppercase tracking-widest mb-4">Your CV</p>
        ...
        <div className="border-t border-[#2a2a2a] pt-5 space-y-5">
          <p className="text-[#f97316] text-xs font-semibold uppercase tracking-widest">Your Application</p>

          <div>
            <label className="block text-[#a1a1aa] text-sm mb-1">Video Introduction (optional)</label>
            ...
            <p className="text-[#555] text-xs mt-1">60–90 second intro video. Loom or Google Drive accepted.</p>
          </div>
          ...
          <div>
            <div className="flex justify-between items-baseline mb-1">
              <label className="text-[#a1a1aa] text-sm">What makes you different?<span className="text-[#f97316] ml-0.5">*</span></label>
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full bg-[#f97316] hover:bg-[#ea580c] disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold py-4 rounded-xl text-lg transition-colors"
        >
          {submitting ? "Submitting..." : "Submit Application →"}
        </button>

        <p className="text-[#555] text-xs text-center">Your information is kept confidential and will only be shared with relevant clients.</p>
      </form>
    </div>
  );
}
